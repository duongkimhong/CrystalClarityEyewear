...
CKFinder.customConfig = function( config )
{
    ...
    config.basePath = '/path-to-ckfinder/';
    ...
    config.uploadUrl = '/path-to-upload-handler/upload-handler.ashx'; // Tùy thuộc vào cấu hình của bạn

    // Cấu hình đường dẫn cho trình duyệt tệp
    config.browseUrl = '/path-to-browse-handler/browse-handler.ashx'; // Tùy thuộc vào cấu hình của bạn
