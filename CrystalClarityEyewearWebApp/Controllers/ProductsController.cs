...
namespace CrystalClarityEyewearWebApp.Controllers
{
    [Authorize]
    public class ProductsController : Controller
    {
        private readonly Areas.Identity.Data.AppContext _context;

        public ProductsController(Areas.Identity.Data.AppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Product != null ? 
                          ...
                          Problem("Entity set 'AppContext.Product'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
